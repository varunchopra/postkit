...
BEGIN
    ...
    EXECUTE format('ALTER TABLE authn.%I ENABLE ROW LEVEL SECURITY', v_partition_name);
    EXECUTE format('ALTER TABLE authn.%I FORCE ROW LEVEL SECURITY', v_partition_name);
